...
<html>
    ...
    <body>
        ...
        <div class="container main">
            <div class="row">
                <div class="col s7"> <h4>ALUNOS - LISTAR</h4> </div>
                <div class="col s5"> <a class="waves-effect waves-light btn" href="alunoInsert.php">
                ...
                <table class="striped">
                    ...
                    <tbody>
                        ...
                        foreach ($lista as $i => $obj) {
                            ...
                            echo '</td>';
                            echo '<td>';
                            echo $obj->getMatricula();
                            echo '</td>';
                            echo '<td>';
                            echo '<a class="waves-effect blue btn" href="alunoUpdate.php?id=' . $obj->getId() . '">ALTERAR</a>'
        ...
        <script>            
            function deletar(id) {              
                ...
                if (window.confirm(mensagem)) {
                    window.open('alunoLista.php?acao=deletar&id='+id,'_self');                    
                    return true;
